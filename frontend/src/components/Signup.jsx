...
const Signup = () => {
  ...
  <div className="modal-box">
    ...
    <div className='flex justify-around mt-4'> 
        <button className='bg-green-700 text-white rounded-md px-3 py-1 hover:bg-green-800 duration-200'>SignUp</button>
        <div className='text-xl'>Have account? <button className='underline text-blue-500 cursor-pointer' onClick={()=>
